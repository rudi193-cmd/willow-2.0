...
_INITIAL_MAPPINGS: list[dict] = [
    ...
    {
        "atom_id": "E81A4267",
        "title": "human_required_queue — Postgres operator action queue",
        "file_paths": ["core/human_required.py"],
        "added_by": "hanuman",
        "note": "Atom describes human_required_queue implementation.",
    },
    {
        "atom_id": "2F19CE8B",
        "title": "health_report.py — Postgres/SAFE/Ollama fleet health script",
        "file_paths": ["scripts/health_report.py"],
        "added_by": "hanuman",
        "note": "Atom describes health_report.py output and exit codes.",
    },
    {
        "atom_id": "30F60129",
        "title": "Boot splash — persona SessionStart hook renderer",
        "file_paths": ["willow/fylgja/boot_splash.py"],
        "added_by": "hanuman",
        "note": "Atom describes boot_splash.py /dev/tty fallback and persona design.",
    },
    {
        "atom_id": "54A878BC",
        "title": "code_graph: Python + JS/TS symbol graph for Willow agents",
        "file_paths": [
        ...
        "added_by": "hanuman",
        "note": "Atom describes code_graph CLI, indexer, and walker behavior.",
    },
    {
        "atom_id": "50E6EB0A",
        "title": "comfort_check — Willow local/CI comfort gate script",
        "file_paths": ["scripts/comfort_check.sh"],
        "added_by": "hanuman",
        "note": "Atom describes comfort_check.sh CI and --local modes.",
    },
    {
        "atom_id": "649E4034",
        "title": "SAFE manifest PGP verification — fleet gate health state",
        "file_paths": ["sap/core/gate.py"],
        "added_by": "hanuman",
        "note": "Atom describes gate.py PGP verify behavior.",
    },
]
