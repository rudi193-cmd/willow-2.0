...
| [theDakshJaitly/mex](https://github.com/theDakshJaitly/mex) | theDakshJaitly | feat: add packages/mex-mcp — MCP server for mex-agent | [PR #84](https://github.com/theDakshJaitly/mex/pull/84) open |
