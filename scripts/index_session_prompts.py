...
def main():
    ...
    parser.add_argument("--min-length", type=int, default=MIN_LENGTH, help=f"Minimum prompt length (default {MIN_LENGTH})")
    ...
    rows = src.execute(sql, (args.min_length,)).fetchall()
