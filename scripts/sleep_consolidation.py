...
Runs after midnight. Four passes:
...
3. Insight pass: cluster N≥3 reflection atoms by domain → Layer 5 insight atom
   (requires Willow MCP available via willow/fylgja/_mcp.py).
4. Chunk pass: cluster N≥2 insight atoms on executable domains → reusable chunk.
