...
**Owner:** sean + hanuman  
**Refs:** KB atoms `61B8FD6B` (Grove MCP nginx/VPS sketch), `932B35B3` (ngrok as authorized scaffolding), `013CDE08` (deployment-layer sovereignty tension), `P4E55FF3` / `DD0808D1` (u2u stack pointers). **Full program (Phases 1–3):** `archive/docs/superpowers/specs/2026-05-12-sovereign-edges-phases-1-3.md` (same branch).
