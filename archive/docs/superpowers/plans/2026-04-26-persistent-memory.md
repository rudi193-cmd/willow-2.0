...
**Files:**
- Modify: `/home/example/.claude/settings.json`

- [ ] **Step 1: Add PostToolUse matchers**

In `/home/example/.claude/settings.json`, replace the existing `PostToolUse` block:
...
"PostToolUse": [
  {
    ...
    "hooks": [
      {
        "type": "command",
        "command": "PYTHONPATH=/home/example/github/willow-1.9 /usr/bin/python3 -m willow.fylgja.events.post_tool",
        "timeout": 5
      }
    ]
  },
...
```bash
python3 -c "
import sys; sys.path.insert(0, '/home/example/github/willow-1.9')
...
```bash
cd /home/example/github/willow-1.9
