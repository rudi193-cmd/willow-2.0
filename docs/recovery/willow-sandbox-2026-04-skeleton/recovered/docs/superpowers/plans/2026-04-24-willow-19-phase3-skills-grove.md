...
```bash
mkdir -p /home/example/github/willow-1.9/.claude/skills
```

- [ ] **Step 2: Create willow-status.md**

```bash
cat > /home/example/github/willow-1.9/.claude/skills/willow-status.md << 'EOF'
---
name: willow-status
...
```bash
cat > /home/example/github/willow-1.9/.claude/skills/willow-fork.md << 'EOF'
---
name: willow-fork
...
```bash
cat > /home/example/github/willow-1.9/.claude/skills/willow-handoff.md << 'EOF'
---
name: willow-handoff
...
```bash
cat > /home/example/github/willow-1.9/.claude/skills/willow-deploy.md << 'EOF'
---
name: willow-deploy
...
```bash
cat > /home/example/github/willow-1.9/.claude/skills/willow-review.md << 'EOF'
---
name: willow-review
