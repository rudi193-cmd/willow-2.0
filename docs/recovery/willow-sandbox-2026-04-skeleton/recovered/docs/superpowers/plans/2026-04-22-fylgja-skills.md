...
```bash
python3 -m willow.fylgja.install --dry-run --plugin --settings /home/example/.claude/settings.json
```
...
```bash
python3 -m willow.fylgja.install --plugin --settings /home/example/.claude/settings.json
```
