...
Create `/home/example/github/willow-1.9/.claude/skills/rlm.md` with this exact content:
...
```bash
head -5 /home/example/github/willow-1.9/.claude/skills/rlm.md
```
...
```bash
git -C /home/example/github/willow-1.9 add .claude/skills/rlm.md
git -C /home/example/github/willow-1.9 commit -m "feat(rlm): add /rlm skill — KB-first recursive LM workflow"
```
...
Create `/home/example/github/willow-1.9/.claude/agents/rlm-subcall.md` with this exact content:
...
```bash
head -8 /home/example/github/willow-1.9/.claude/agents/rlm-subcall.md
```
...
```bash
git -C /home/example/github/willow-1.9 add .claude/agents/rlm-subcall.md
git -C /home/example/github/willow-1.9 commit -m "feat(rlm): add rlm-subcall Haiku subagent for chunk analysis"
```
...
Open `/home/example/github/willow-1.9/.gitignore` and add after the `# Claude Code worktrees` block:
...
```bash
grep "rlm_state" /home/example/github/willow-1.9/.gitignore
```
...
```bash
git -C /home/example/github/willow-1.9 add .gitignore
git -C /home/example/github/willow-1.9 commit -m "chore: add .claude/rlm_state/ to .gitignore"
```
