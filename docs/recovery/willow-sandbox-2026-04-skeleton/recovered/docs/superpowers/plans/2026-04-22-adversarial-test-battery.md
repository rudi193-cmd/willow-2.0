...
```bash
touch /home/example/github/willow-1.9/tests/adversarial/__init__.py
touch /home/example/github/willow-1.9/tests/adversarial/e2e/__init__.py
```
...
```bash
cd /home/example/github/willow-1.9 && python3 -m pytest tests/adversarial/ --collect-only 2>&1 | head -20
```
...
```bash
cd /home/example/github/willow-1.9 && python3 -m pytest tests/adversarial/test_injection.py -v 2>&1
```
...
```bash
cd /home/example/github/willow-1.9 && python3 -m pytest tests/adversarial/test_prompt_injection.py -v 2>&1
```
...
```bash
cd /home/example/github/willow-1.9 && python3 -m pytest tests/adversarial/test_rate_limiting.py -v 2>&1
```
...
```bash
cd /home/example/github/willow-1.9 && python3 -m pytest tests/adversarial/test_cross_project.py -v 2>&1
```
...
```bash
cd /home/example/github/willow-1.9 && python3 -m pytest tests/adversarial/test_integrity.py -v 2>&1
```
...
```bash
cd /home/example/github/willow-1.9 && python3 -m pytest tests/adversarial/test_malformed.py -v 2>&1
```
...
```bash
cd /home/example/github/willow-1.9 && python3 -m pytest tests/adversarial/e2e/ --collect-only 2>&1 | head -20
```
...
```bash
cd /home/example/github/willow-1.9 && python3 -m pytest tests/adversarial/e2e/test_ddos.py -v 2>&1
```
...
```bash
cd /home/example/github/willow-1.9 && python3 -m pytest tests/adversarial/e2e/test_bad_agent.py -v 2>&1
```
...
```bash
cd /home/example/github/willow-1.9 && python3 -m pytest tests/adversarial/ --ignore=tests/adversarial/e2e -v 2>&1
```
...
```bash
cd /home/example/github/willow-1.9 && python3 -m pytest --ignore=tests/adversarial/e2e -q 2>&1
```
