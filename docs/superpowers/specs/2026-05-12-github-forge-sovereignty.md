...
**Refs:** `docs/superpowers/specs/2026-05-12-sovereign-edges-phases-1-3.md` (sequencing ethos), `docs/superpowers/specs/2026-05-12-willow-git-shaped-state-machine.md` (shape over host), `docs/superpowers/specs/2026-05-12-project-overseer-process.md`, `scripts/run_overseer.py`
