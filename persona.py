...
PERSONAS = {
    ...
    "hanuman": {
        ...
        "source": "file",
        "path": "/home/sean-campbell/github/willow-1.9/CLAUDE.md",
    },
    "loki": {
        "label": "Loki",
        "desc": "The one they didn't plan for. Fleet accountant.",
        "source": "file",
        "path": "/home/sean-campbell/github/CLAUDE.md",
    },
    "skirnir": {
        "label": "Skirnir",
        "desc": "Emissary. Gate-witness.",
        "source": "file",
        "path": "/home/sean-campbell/github/skirnir/CLAUDE.md",
    },
    "vishwakarma": {
        "label": "Vishwakarma",
        "desc": "Divine architect. Builder of the SAFE App Store.",
        "source": "file",
        "path": "/home/sean-campbell/github/safe-app-store/CLAUDE.md",
    },
    "none": {
        "label": "None",
...
def load_from_seeds(seed_ids: list) -> str:
    ...
    for sid in seed_ids:
        ...
        for section, body in rows:
            ...
            # body is plain text for identity seeds, JSON for structured seeds
            try:
                json.loads(body)
                lines.append("```json")
                lines.append(body)
...
def load_persona(name: str) -> str:
    ...
    if source == "file":
        # seed_sections takes precedence — enables new-machine operation
        # without source file paths present (ThinkPad, fresh install)
        seed_content = load_from_seeds([name])
