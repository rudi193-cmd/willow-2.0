...
> Auto-generated by `scripts/gen_index.py` on 2026-07-20. Add or update descriptions in `scripts/index_annotations.json`.
...
| `docs/NEST_FEEDBACK_SCHEMA.md` |
| `docs/OPENCLAW_DISCORD_SETUP.md` |
| `docs/PUBLIC_READY_V1.md` |
